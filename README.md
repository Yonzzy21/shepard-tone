...
Based on the Web Audio Shepard tone approach described in [this article](https://jordaneldredge.com/blog/creating-the-shepard-tone-audio-illusion-with-javascript/).
